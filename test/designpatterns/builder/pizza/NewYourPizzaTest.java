...
public class NewYourPizzaTest {
  ...
  public void shouldBeAbleToSetTheSize() {
    NewYourPizza newYourPizza1 = new NewYourPizza.Builder(Size.SMALL).build();
    assertEquals(Size.SMALL, newYourPizza1.getSize());
    NewYourPizza newYourPizza2 = new NewYourPizza.Builder(Size.MEDIUM).build();
    assertEquals(Size.MEDIUM, newYourPizza2.getSize());
    NewYourPizza newYourPizza3 = new NewYourPizza.Builder(Size.LARGE).build();
    assertEquals(Size.LARGE, newYourPizza3.getSize());
  }

  @Test
  public void shouldBeAbleToAddToppings() {
    NewYourPizza newYourPizza = new NewYourPizza.Builder(Size.SMALL).addTopping(Topping.HAM)
